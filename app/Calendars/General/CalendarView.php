    ...
    foreach ($weeks as $week) {
      ...
      foreach ($days as $day) {
        ...
        if ($startDay <= $day->everyDay() && $toDay >= $day->everyDay()) {
          ...
          // class名をpast-dayにすることでcssに記載されている内容が反映される
          //
        } else {
        ...
        if (in_array($day->everyDay(), $day->authReserveDay())) {
          ...
          //             $html[] = '<p class="m-auto p-0 w-75" style="font-size:12px"></p>'　$html[] = '<input type="hidden" name="getPart[]" value="" form="reserveParts">';は複製して使う
          // authReserveDateは特定の日付に紐づく予約データを取得する
          if ($startDay <= $day->everyDay() && $toDay >= $day->everyDay()) {
